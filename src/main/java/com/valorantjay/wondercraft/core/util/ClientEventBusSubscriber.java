package com.valorantjay.wondercraft.core.util;

import com.valorantjay.wondercraft.WonderCraft;
import com.valorantjay.wondercraft.client.screen.DisplayCaseScreen;
...
@Mod.EventBusSubscriber(modid = WonderCraft.MOD_ID, bus = Bus.MOD, value = Dist.CLIENT)
